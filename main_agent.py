...
# ✅ AI/ML API client setup
from openai import OpenAI
client = OpenAI(
    base_url="https://api.aimlapi.com/v1",
    api_key=os.environ.get("AIML_API_KEY", "7dde8ea84fe94db7918eed4ca76b91be"),
)
...
def main():
    ...
    if args.mode == 'server':
        # Run FastAPI server for deployment
    ...
    # print JSON for Coral registry or CLI use
